import { GradeService } from "../src/modules/grades/services/GradeService";
import { IGradeRepository, IGrade, IStudent } from "../src/modules/grades/domain/interfaces";
import { mock, MockProxy } from "jest-mock-extended";

describe("GradeService", () => {
    let gradeService: GradeService;
    let gradeRepository: MockProxy<IGradeRepository>;
    ...
    beforeEach(() => {
        gradeRepository = mock<IGradeRepository>();
